...
do local GUI = game.CoreGui:FindFirstChild("Darkrai");if GUI then GUI:Destroy();end;if _G.Color == nil then
       _G.Color = Color3.fromRGB(163, 5, 255)
   end 
end
...
function DarkraiX:Window(text,gamenme,logo,keybind)
	...
	function uitab:Tab(text)
		...
		TabButton.Font = Configs_HUB.Text_Font
		...
		function main:Button(text,callback)
			...
			TextBtn.Font = Configs_HUB.Text_Font
			TextBtn.Text = text
		...
		function main:Toggle(text,config,callback)
			...
			ToggleImage.BackgroundColor3 = Color3.fromRGB(225, 255, 255)
			...
			Button.MouseButton1Click:Connect(function()
				if toggled == false then
					...
					TweenService:Create(
						Circle,
						TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
						{BackgroundColor3 = Color3.fromRGB(5, 255, 10)}
					):Play()
				else
					toggled = false
		...
		function main:Slider(text,min,max,set,callback)
			...
			SliderLabel.Font = Configs_HUB.Text_Font
			...
			TextBox.Font = Configs_HUB.Text_Font
		...
		function main:Textbox(text,disappear,callback)
			...
			TextboxLabel.Font = Configs_HUB.Text_Font
			...
			txtbtn.Font = Configs_HUB.Text_Font
			txtbtn.Text = ""
			...
			RealTextbox.Font = Configs_HUB.Text_Font
			RealTextbox.Text = ""
